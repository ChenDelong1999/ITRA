...
from itra.data.train_data import ImageNet_nori
from itra.data.classification_datasets import get_dataset
...
if __name__ == '__main__':
    ...
    # RN50, ViT-B-16, ViT-B-32, ViT-L-14
    args = parse_args()
    args.rank = 0
    args.device = 'cuda:0'
    args.zeroshot_frequency = 1
    # args.datasets_dir = './datasets'
    args.datasets_dir = '/home/zts/datasets/remote_sensing'
    args.resume = ""
    args.evaluation_workers = 4
    ...
    print(f'text_model:{args.text_model}, image_model:{args.image_model}')

    results = zero_shot_eval(model, 'RS2800', 200, preprocess_val, args)
    print(results)
