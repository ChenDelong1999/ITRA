...
torchrun --nproc_per_node 8 -m training.main \
    ...
    --epochs 100 --save-frequency 10 --batch-size 512 --workers 8 \
    ...
    --distiller 'SimReg' \
    --report-to tensorboard --logs 'logs/Stage1' --copy-codebase --name 'U[RN50-h2]-[SimReg]-L[all-roberta-large-v1]-bs4096-100ep'
