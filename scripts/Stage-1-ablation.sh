...
#     --report-to tensorboard --logs 'logs/Stage1-ablation' --copy-codebase --name 'U[RN50-h2]-U[CLIP-from-scratch]-bs800-8ep'
...
#     --distiller 'InfoNCE' --find-unused-parameters \
#     --report-to tensorboard --logs 'logs/Stage1-ablation' --copy-codebase --name 'U[RN50-h2]-U[all-roberta-large-v1]-bs800-8ep'
