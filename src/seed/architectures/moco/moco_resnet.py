...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           ...
           'wide_resnet50_2', 'wide_resnet101_2', 'resnext152_32x8d']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, width_multiplier=1, num_classes=1000, zero_init_residual=False,
    ...
    def _forward_impl(self, x, fc=True):
    ...
    def forward(self, x, fc=True):
        return self._forward_impl(x, fc)
