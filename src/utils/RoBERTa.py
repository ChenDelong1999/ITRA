...
class TextDataset():
    def __init__(self, input_filename, tokenizer, caption_key='title', sep="\t") -> None:
        ...
        if input_filename[:2]=='s3':
            ...
            df = pd.read_csv(smart_open(input_filename, "r"), sep='\t')
...
if __name__ == '__main__':
    # 's3://chendelonghahab/datasets/ConceptualCaption3M/nori_CC2716261.csv',
    # 's3://chendelonghahab/datasets/YFCC/YFCC_cleaned_nori.csv',
