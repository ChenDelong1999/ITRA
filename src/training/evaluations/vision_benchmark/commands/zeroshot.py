...
def add_zero_shot_args(parser):
    parser.add_argument('--log_dir', required=False, default='', help='for custom model.', type=str)
    parser.add_argument('--ckpt_epoch', required=False, default='latest', help='for custom model.', type=str)
    parser.add_argument('--dataset_root', required=False, default='', help='../dataset/', type=str)
